...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    '& .MuiButton-outlinedPrimary': {
      color: theme.mode === 'light' ? '#b60101' : '#FFF',
      border: theme.mode === 'light' ? '1px solid rgba(3 45 122)' : '1px solid rgba(255, 255, 255, 0.5)',
    },
    '& .MuiTab-textColorPrimary.Mui-selected': {
      color: theme.mode === 'light' ? '#042d7a' : '#FFF',
    }
  },
  avatar: {
    width: "100%",
...
//############Comente com // para retrair ou descomente para reexibindo o menu lateral############
//  useEffect(() => {
