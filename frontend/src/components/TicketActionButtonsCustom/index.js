...
const TicketActionButtonsCustom = ({ ticket }) => {
	...
	const handleUpdateTicketStatus = async (e, status, userId) => {
		setLoading(true);
		try {
			// ✅ CORRIGIR OS VALORES PARA O BANCO - usar null ao invés de false para campos INTEGER
			const updateData = {
				status: status,
				userId: userId || null,
				useIntegration: status === "closed" ? false : ticket.useIntegration,
				promptId: status === "closed" ? null : ticket.promptId, // ✅ null ao invés de false
				integrationId: status === "closed" ? null : ticket.integrationId // ✅ null ao invés de false
			};
