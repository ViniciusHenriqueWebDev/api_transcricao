...
const performanceCampaignRoutes_1 = __importDefault(require("./performanceCampaignRoutes"));
const employeeGoalRoutes_1 = __importDefault(require("./employeeGoalRoutes"));
...
const actionPlanRoutes_1 = __importDefault(require("./actionPlanRoutes"));
const routes = (0, express_1.Router)();
routes.use("/webhooks", webhookRoutes_1.default);
...
routes.use(employeeRoutes_1.default);
routes.use(goalRoutes_1.default);
routes.use(performanceCampaignRoutes_1.default);
routes.use(employeeGoalRoutes_1.default);
routes.use(featureRoutes_1.default);
routes.use(analyticsRoutes_1.default);
routes.use(actionPlanRoutes_1.default);
