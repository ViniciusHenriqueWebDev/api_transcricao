...
subscriptionRoutes.post("/subscription/mercadopago", isAuth_1.default, SubscriptionController.createMercadoPagoPayment);
subscriptionRoutes.post("/subscription/mp-webhook", SubscriptionController.mercadoPagoWebhook);
subscriptionRoutes.post("/subscription/check-payment", isAuth_1.default, SubscriptionController.checkMercadoPagoPaymentStatus);
subscriptionRoutes.post("/subscription/cancel-payment", isAuth_1.default, SubscriptionController.cancelMercadoPagoPayment);
