...
const store = async (req, res) => {
    const { body, sendAt, contactId, userId, whatsappId, queueId, status, atendenteId, ticketStatus, recurrenceType, recurrenceValue, recurrenceTimes, recurrencePattern, openTicket, sendSignature } = req.body;
    const { companyId } = req.user;
    const schedule = await (0, CreateService_1.default)({
        ...
        recurrenceValue,
        recurrenceCount: recurrenceTimes,
        recurrenceDayOptions: recurrencePattern,
