...
exports.logoutBrowser = exports.remove = exports.me = exports.update = exports.store = void 0;
...
const logoutBrowser = async (req, res) => {
    try {
        const { id } = req.user;
        const user = await User_1.default.findByPk(id);
        if (user) {
...
exports.logoutBrowser = logoutBrowser;
