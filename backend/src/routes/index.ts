...
import performanceCampaignRoutes from "./performanceCampaignRoutes";
import employeeGoalRoutes from "./employeeGoalRoutes";
import featureRoutes from "./featureRoutes";
import analyticsRoutes from "./analyticsRoutes"; 
import webhooksRoutes from "./webhookRoutes";
...
routes.use(performanceCampaignRoutes);
routes.use(employeeGoalRoutes);
