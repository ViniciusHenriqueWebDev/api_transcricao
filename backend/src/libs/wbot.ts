        ...
        wsocket.ev.on("connection.update",
          async ({ connection, lastDisconnect, qr }) => {
            ...
            if (lastDisconnect) {
              ...
              logger.error(`Disconnection error details: Status code: ${statusCode}, Error message: ${lastDisconnect.error.message}`);
              logger.error(`Stack trace: ${lastDisconnect.error.stack}`);
            }
            ...
            if (connection === "close") {
              ...
              logger.error(`Full error details: ${JSON.stringify(disconnectError)}`);
